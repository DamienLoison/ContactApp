    ...
    <body>
        ...
        <div class="Choix">
            ...
            <select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                ...
                <option disabled id="disabled" class="Contact" value="recherche_contact">Recherche de contact</option>
                <!-- recherche organisation-->
                <option class="Organisation" value="toute_les_organisations">Afficher toute les organisations</option>
                <option disabled id="disabled" class="Organisation" value="recherche_organisation">Recherche d'organisation</option>
                <!-- reherche login -->
                <option class="Login " value="tout_les_login">Tout les login</option>
                <option disabled id="disabled" class="Login " value="recherche_de_login">Recherche d'un login</option>
            </select>
        </div>
    </body>
</html>